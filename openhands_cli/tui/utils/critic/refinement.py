...
class Feature(TypedDict, total=False):
    """Type definition for critic feature dictionaries.

    Represents a feature detected by the critic, such as an agent behavioral
    issue (e.g., insufficient_testing, loop_behavior).
    """
...
def _format_feature_for_prompt(feature: Feature) -> str:
...
def get_high_probability_issues(
    ...
    Returns:
        List of Feature dicts with 'name', 'display_name', and 'probability'
    """
...
def build_refinement_message(
    ...
    *,
    ...
    triggered_issues: list[Feature] | None = None,
) -> str:
