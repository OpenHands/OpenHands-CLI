...
class TestConversationLister:
    ...
    def test_nonexistent_directory(self):
        ...
        with patch(
            "openhands_cli.conversations.lister.CONVERSATIONS_DIR", "/nonexistent/path"
        ):
            lister = ConversationLister()
            conversations = lister.list()
            assert conversations == []
    ...
    def test_single_conversation(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            with patch(
                ...
                with open(
                    events_dir
                    / "event-00000-657fde4a-8d61-487f-a473-3f6808bf1231.json",
                    "w",
                ) as f:
                ...
                assert conv.created_date == datetime.fromisoformat(
                    "2025-10-21T15:17:29.421124"
                )
    ...
    def test_invalid_conversation_directory(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            with patch(
                ...
                with open(
                    invalid_json_events_dir / "event-00000-invalid.json", "w"
                ) as f:
