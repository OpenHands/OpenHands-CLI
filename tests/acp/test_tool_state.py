...
from openhands_cli.acp_impl.events.tool_state import ToolCallState, _title_from_streaming_args
...
class TestTitleFromStreamingArgs:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("file_editor", '{"command": "view", "path": "/test/file.py"}', "Reading /test/file.py"),
            # file_editor with other commands (edit)
            ("file_editor", '{"command": "str_replace", "path": "/src/main.py"}', "Editing /src/main.py"),
            ("file_editor", '{"command": "create", "path": "/new/file.txt"}', "Editing /new/file.txt"),
            ("file_editor", '{"command": "insert", "path": "/code.py"}', "Editing /code.py"),
    ...
    def test_title_from_invalid_json(self):
        """Test title generation with invalid/incomplete JSON falls back to tool_name."""
        import streamingjson
        lexer = streamingjson.Lexer()
