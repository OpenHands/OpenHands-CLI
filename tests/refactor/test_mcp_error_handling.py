...
class TestMCPErrorHandling:
    ...
    def test_mcp_connection_failure_during_setup(self, mock_agent_store, invalid_mcp_config):
    ...
    def test_mcp_config_validation_error(self, temp_config_path):
        ...
        from openhands_cli.mcp.mcp_utils import load_mcp_config, MCPConfigurationError
        
        with pytest.raises(MCPConfigurationError, match="Invalid MCP configuration file"):
            load_mcp_config()
