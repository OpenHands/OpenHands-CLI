...
class TestPersistenceDir:
    ...
    def test_returns_none_when_no_conversation(self, mock_runner):
    ...
    def test_returns_none_when_no_state(self, mock_runner):
    ...
    def test_returns_path_when_available(self, mock_runner):
